...
function eventtusWidget() {
  ...
  document.getElementById('eventtusWidgetContainer').onclick = function () {
    ...
    try {
      ...
      iframe.style =
        `position: fixed; top: 0px; left: 0px; display: block; margin: 0px; padding: 0px; border: none; height: 100vh; width: 100vw; z-index: 2147483647; background: url(${loaderIcon}) center center no-repeat; background-color: rgba(56, 64, 74, 0.9); transition: background-color 1s cubic-bezier(0.645, 0.045, 0.355, 1)`;
